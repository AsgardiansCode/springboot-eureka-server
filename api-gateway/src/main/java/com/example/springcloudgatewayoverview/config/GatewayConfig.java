...
import com.example.springcloudgatewayoverview.model.Drug;
...
public class GatewayConfig {
    ...
    public RouteLocator customRouteLocator(RouteLocatorBuilder builder) {
        ...
        return builder.routes()
                .route("first-microservice",r -> r.path("/drugs_list")
                        .and().method("POST")
                        .and().readBody(Drug.class, s -> true).filters(f -> f.filters(requestFilter, authFilter))
